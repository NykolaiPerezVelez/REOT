...
public class Formulario extends AppCompatActivity {
    ...
    @InjectView(R.id.input_par) EditText _parText;
    @InjectView(R.id.btn_arboles) Button _arbolesButton;
    ...
    public void onSignupSuccess() {
        ...
        Intent datosArboles1 = new Intent(Formulario.this, DatosArboles1.class);
