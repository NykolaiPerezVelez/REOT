...
public class DatosArboles3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_datos_arboles3);
    ...
    public void signup() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(DatosArboles3.this,
    ...
    public void onSignupSuccess() {
        ...
        Intent datosArboles4 = new Intent(DatosArboles3.this, DatosArboles4.class);
        startActivity(datosArboles4);
        //
        //
        //
        // finish();
    ...
    public boolean validate() {
        ...
        if (numero.isEmpty()) {
            _numeroFrenteText.setError("Ingrese cazuela");
            valid = false;
        } else {
        ...
        if (arbol.isEmpty()) {
            _numeroArbolText.setError("Debe ingresar la distancia entre plantas");
            valid = false;
        } else {
        ...
        if (especie.isEmpty()) {
            _especieText.setError("Indique la distancia al muro");
            valid = false;
        } else {
